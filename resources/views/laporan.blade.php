      ...
      <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
          ...
          <div class="navbar-nav w-100">
            ...
            >
            <a href="{{ route('admin.laporan', ['employeeId' => $employeeId]) }}" class="nav-item nav-link active"
            ...
            <div class="col-sm-6 col-xl-3">
              ...
              >
                ...
                <div class="ms-3">
                  ...
                  <h6 class="mb-0">{{ \App\Models\transaction::max('tsc_id') }}</h6>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-xl-3">
              ...
              >
                ...
                <div class="ms-3">
                  ...
                  <h6 class="mb-0">
                    {{ number_format(\App\Models\Transaction::where('created_at', '>=', \Carbon\Carbon::now()->subDays(30))->sum('tsc_totalprice'), 0, ',', '.') }}
                  </h6>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-xl-3">
              ...
              >
                ...
                <div class="ms-3">
                  ...
                  <h6 class="mb-0">
                    {{ number_format(\App\Models\Expense::where('created_at', '>=', \Carbon\Carbon::now()->subDays(30))->sum('exp_totalexpense'), 0, ',', '.') }}
                  </h6>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-xl-3">
              ...
              >
                ...
                <div class="ms-3">
                  ...
                  <h6 class="mb-0">
                    {{ number_format(\App\Models\Transaction::where('created_at', '>=', \Carbon\Carbon::now()->subDays(30))->sum('tsc_totalprice') - \App\Models\Expense::where('created_at', '>=', \Carbon\Carbon::now()->subDays(30))->sum('exp_totalexpense'), 0, ',', '.') }}
                  </h6>
                </div>
