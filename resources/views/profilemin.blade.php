      ...
      <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
          ...
          <div class="d-flex align-items-center ms-4 mb-4">
            ...
            <div class="ms-3">
              <h6 class="mb-0">{{ $user->epl_name }}</h6>
              <span>Admin</span>
            </div>
          </div>
            ...
            <div class="nav-item dropdown">
              ...
              >
                <img
                  ...
                  style="width: 40px; height: 40px"
                />
                <span class="d-none d-lg-inline-flex">{{ $user->epl_name }}</span>
              </a>
              <div
            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{ $user->epl_name }}" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="labels">Job Title</label>
                        <input type="text" class="form-control" value="{{ $user->epl_jobtitle }}" readonly>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12">
                        <label class="labels">Umur</label>
                        <input type="text" class="form-control" value="{{ $user->epl_age }}" readonly>
                    </div>
                    <div class="col-md-12">
                        <label class="labels">Nomor Telepon / WhatsApp</label>
                        <input type="text" class="form-control" value="{{ $user->epl_phonenumber }}" readonly>
                    </div>
                    <div class="col-md-12">
                        <label class="labels">Gender</label>
                        <input type="text" class="form-control" value="{{ $user->epl_gender }}" readonly>
                    </div>
                </div>
            </div>
        </div>
