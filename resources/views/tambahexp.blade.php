            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
              <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                ...
                <div class="form-floating mb-3">
                  ...
                  <div class="btns-group" style="background-color: #009CFF; border-radius: 0.25rem; display: flex; justify-content: center; align-items: center;">
                    <input style="color: white;" type="submit" value="Submit" class="btn center" />
                  </div>
