        ...
        >
          ...
          >
            <div class="navbar-nav ml-auto py-0">
              ...
              <a href="{{ route('customer.about', ['customerId' => $customerId]) }}" class="nav-item nav-link active">About</a>
        ...
        <div class="row align-items-center py-4">
          ...
          <div class="col-md-6 text-center text-md-right">
            <div class="d-inline-flex align-items-center">
              ...
              <a class="btn text-white disabled" href="{{ route('customer.about', ['customerId' => $customerId]) }}">About Us</a>
            </div>
          </div>
        </div>
      </div>
